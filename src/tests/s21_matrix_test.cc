...
TEST(Test, test_base_constructor_1) {
  S21Matrix my_matrix;
  ASSERT_EQ(my_matrix.GetCols(), 0);
  ASSERT_EQ(my_matrix.GetRows(), 0);
}

TEST(Test, test_param_constructor_1) {
  S21Matrix my_matrix(2, 2);
  ASSERT_EQ(my_matrix.GetCols(), 2);
  ASSERT_EQ(my_matrix.GetRows(), 2);
...
TEST(Test, test_param_constructor_2) {
  ...
  ASSERT_EQ(my_matrix.GetCols(), 10);
  ASSERT_EQ(my_matrix.GetRows(), 10);
}

TEST(Test, test_param_constructor_3) {
  S21Matrix my_matrix(2, 5);
  ASSERT_EQ(my_matrix.GetCols(), 5);
  ASSERT_EQ(my_matrix.GetRows(), 2);
}
...
TEST(Test, test_copy_constructor_1) {
  ...
  ASSERT_EQ(new_matrix.GetCols(), my_matrix.GetCols());
  ASSERT_EQ(new_matrix.GetRows(), my_matrix.GetCols());
}
...
TEST(Test, test_getters_setters) {
  ...
  ASSERT_EQ(my_matrix.GetRows(), 3);
  ASSERT_EQ(my_matrix.GetCols(), 3);

  ASSERT_ANY_THROW(my_matrix.SetRows(-1));
  ASSERT_ANY_THROW(my_matrix.SetCols(-5));
...
TEST(Test, test_calc_compliments_2) {
  ...
  ASSERT_NEAR(result(0, 0), -80, 1e-3);
  ASSERT_NEAR(result(0, 1), 44, 1e-3);
  ASSERT_NEAR(result(0, 2), 5, 1e-3);
  ASSERT_NEAR(result(0, 3), 11, 1e-3);

  ASSERT_NEAR(result(1, 0), 18, 1e-3);
  ASSERT_NEAR(result(1, 1), -270, 1e-3);
  ASSERT_NEAR(result(1, 2), 35, 1e-3);
  ASSERT_NEAR(result(1, 3), 77, 1e-3);

  ASSERT_NEAR(result(2, 0), 32, 1e-3);
  ASSERT_NEAR(result(2, 1), 98, 1e-3);
  ASSERT_NEAR(result(2, 2), -2, 1e-3);
  ASSERT_NEAR(result(2, 3), -120, 1e-3);

  ASSERT_NEAR(result(3, 0), -40, 1e-3);
  ASSERT_NEAR(result(3, 1), 22, 1e-3);
  ASSERT_NEAR(result(3, 2), -142, 1e-3);
  ASSERT_NEAR(result(3, 3), 150, 1e-3);
}
...
TEST(Test, test_calc_compliments_3) {
  ...
  ASSERT_NEAR(result(0, 2), -5, 1e-3);
  ASSERT_NEAR(result(0, 3), -11, 1e-3);
  ASSERT_NEAR(result(0, 4), 0, 1e-3);

  ASSERT_NEAR(result(1, 0), -18, 1e-3);
  ASSERT_NEAR(result(1, 1), 270, 1e-3);
  ASSERT_NEAR(result(1, 2), -35, 1e-3);
  ASSERT_NEAR(result(1, 3), -77, 1e-3);
  ASSERT_NEAR(result(1, 4), -0, 1e-3);

  ASSERT_NEAR(result(2, 0), -32, 1e-3);
  ASSERT_NEAR(result(2, 1), -98, 1e-3);
  ASSERT_NEAR(result(2, 2), 2, 1e-3);
  ASSERT_NEAR(result(2, 3), 120, 1e-3);
  ASSERT_NEAR(result(2, 4), 0, 1e-3);

  ASSERT_NEAR(result(3, 0), 18, 1e-3);
  ASSERT_NEAR(result(3, 1), 308, 1e-3);
  ASSERT_NEAR(result(3, 2), -254, 1e-3);
  ASSERT_NEAR(result(3, 3), -212, 1e-3);
  ASSERT_NEAR(result(3, 4), 578, 1e-3);

  ASSERT_NEAR(result(4, 0), 22, 1e-3);
  ASSERT_NEAR(result(4, 1), -330, 1e-3);
  ASSERT_NEAR(result(4, 2), 396, 1e-3);
  ASSERT_NEAR(result(4, 3), 62, 1e-3);
  ASSERT_NEAR(result(4, 4), -578, 1e-3);
}
